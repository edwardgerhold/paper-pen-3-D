...
\begin{displaymath}
\begin{align}
c := \max_{\vec{v} \in V}\{ \frac{\|\boldsymbol{A}\vec{v}\|}{\|\vec{v}\|} \} = \frac{\|(\boldsymbol{A}\vec{v})_{max}\|}{\|\vec{v}\|}
\end{align}
\end{displaymath}
...
\begin{displaymath}
\begin{align}
\|\boldsymbol{A}\vec{v}\| \leq \frac{\|(\boldsymbol{A}\vec{v})_{max}\|}{\|\vec{v}\|}\|\vec{v}\| \\
&= \|\boldsymbol{A}\vec{v}\| \leq \|(\boldsymbol{A}\vec{v})_{max}\|\\
&= \|\vec{w}\| \leq c\|\vec{v}\| \\
\end{align}
\end{displaymath}
