...
doing it for three components.\\
With $\vec{x}_i$ as the coordinate components and $\vec{e}_i$ as the corresponding basis vector component and $\vec{v}$ as the resulting new vector. $n$ is the target dimension. In our case it is $n = 2$. And we sum three components up.
