...
In the next versions i will clean up and finish the existing before examining more rules.\\
...
\begin{displaymath}
f(t) = f_{1}(t)\begin{pmatrix}\cos\varphi_1\\\sin\varphi_1\end{pmatrix}
        +f_{2}(t)\begin{pmatrix}\cos\varphi_2\\\sin\varphi_2\end{pmatrix}
        +f_{3}(t)\begin{pmatrix}\cos\varphi_3\\\sin\varphi_3\end{pmatrix}
\end{displaymath}

Remark. It is the same as the functional $\vec{f}(\vec{x})$ just written clearly. Will overwork.
...
This is the cosine series as partial sum (finite summation) from zero to n:\\
\begin{displaymath}
...
Now for the second vector we remove the linear parts from the first. And normalize in the second step.
...
Now we have three new vectors. In a $n\times n$ system, they will be linearly independent and form a orthogonal basis.\\

Remark. I have not verified or examined or observed the outcome today. I want to look at the images from functions then next.\\
...
\begin{displaymath}
    E^{\mathbb{R}^{2\times{3}}}_{yz} = \begin{pmatrix}-2^{-\frac12}&0&1\\-2^{-\frac12}&1&0\end{pmatrix}
\end{displaymath}
...
\begin{align}
\vec{e}_{y} &= \begin{pmatrix}1\\0\end{pmatrix}
\vec{b} = \begin{pmatrix}1\\0\end{pmatrix} - (-\sqrt{frac12} + 0)\begin{pmatrix}1\\0\end{pmatrix} \\
    &= \begin{pmatrix}1-\sqrt{\frac12}\\0\end{pmatrix}\\
\vec{q}_{2} &= \frac{\vec{b}}{\|\vec{b}\|} \\
            &= \begin{pmatrix}\frac{1-\sqrt{\frac12}} { \sqrt{\frac32-\frac{2}{\sqrt{2}}} }\\0\end{pmatrix}\\
\end{align}
\end{displaymath}

And for the third vector, the last term, the $q_2$ term, is getting zero. Simpler than it looked like \\

\begin{displaymath}
\begin{align}
\vec{e}_{z} &= \begin{pmatrix}0\\1\end{pmatrix}\\
\vec{c} &= \begin{pmatrix}0\\1\end{pmatrix} - (-\sqrt{\frac12})\begin{pmatrix}-\sqrt{\frac12}\\-\sqrt{\frac12}\end{pmatrix} - 0\\
        &=  \begin{pmatrix}-\frac12\\\frac12\end{pmatrix}\\
\vec{q}_{3} &= \frac{\vec{c}}{\|\vec{c}\|}
            &= \begin{pmatrix}\frac{-\frac12}{\sqrt{\frac12}}\\\frac{\frac12}{\sqrt{\frac12}}\end{pmatrix}
\end{align}
\end{displaymath}
...
\vec{q}_{2} &= \begin{pmatrix}\frac{1-\sqrt{\frac12}} { \sqrt{\frac32-\frac{2}{\sqrt{2}}} }\\0\end{pmatrix}\\
\vec{q}_{3} &= \begin{pmatrix}\frac{-\frac12}{\sqrt{\frac12}}\\\frac{\frac12}{\sqrt{\frac12}}\end{pmatrix}
\end{align}
\end{displaymath}


Remark. I have not drawn with them yet.
...
Underways i subtracted lamda and solved for the determinant using the crossproduct and determinat formula for handwritten determinants of 3x3 matrices.\\
...
\begin{thebibliography}
    ...
    \bibitem{Toplogy} \textit{John Rogues, Lecture Notes on Topology, following J.R.Munkers Textbook, for MAT3500/4500},
