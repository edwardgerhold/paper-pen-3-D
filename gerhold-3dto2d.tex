...
\subsection{Defining the $(2\times3)\cdot(3\times1)$ as transitional space to go from 3-D to 2-D}
...
Solving $det(A-\lambdaI)=0$ gives us the characteristic polynomial and after foiling and simplification
...
Oh, and i forgot. A 3x3 polynomial should have three roots. I guess, the third root is also 1. So all three eigenvalues of the 3x3 matrix are $0,1,1$.
\begin{displaymath}
\lambda_{1} = 0\qquad\lambda_{2}=1\qquad\lambda_{3}=1
\end{displaymath}
...
\begin{thebibliography}\bibitem{Corral1}\textit{Michael Corral, Schoolcraft College},
    ...
    \bibitem{Vershynin1} \textit{Roman Vershinin. Lectures in Functional Analysis. Department of Mathematics, University of Michigan},
            Lecture Script, http://,        
