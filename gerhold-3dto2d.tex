...
Version 0.1.7 (very drafty paper)\\
...
\texbf{Remark} The length of $r$ can be determined by pulling the squareroot out of the sum of the squares of the vector.
...
$r = \sqrt{\vec{x} \dot \vec{x}}$ = \left(\Sigma_{i=1}^{n} \vec{x}_i\vec{x}_i\right)^{\frac{1}{2}}$.\\


Now about the multiplication.\\
...
I can not speak for all, and don´t believe, that no one told no one about this, 
but i haven´t met any one in twenty years telling me about this easy transformation.\\
