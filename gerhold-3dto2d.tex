...
\textbf{Remark} Seems to be equal now. But i am not sure. Update: I spotted another mistake and this seems to be wrong, as i square left the sum, and right each component of the sum.
But that will be calculated the days. Thanks for the place.
