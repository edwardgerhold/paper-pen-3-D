...
2x3 & 3x2 & 2x2&\\
2x3 & 3x3 & 2x3&\\
2x3 & 3x4 & 2x4& 4-D to 2-D mapping\\
\end{tabular}\\
...
\newtheorem{PropositionOpt}{Proposition. The \mathbb{R}^{2\times3} has infinite combination possibilities $(m\times c)\cdot(c\times n)=(m\times n)$}
...
Remark. Got to prove it. Will find a good prove for.
