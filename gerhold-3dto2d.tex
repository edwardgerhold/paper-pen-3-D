...
Version 0.2.4 (the very much a draft paper)\\
...
\boldsymbol{A} should be treated as operator $\boldsymbol{A} : \mathbb{R}^3 \rightarrow \mathbb{R}^2$. $\vec{x} e \boldsymbol{A}\vec{x}$. 
\end{Definition}\\
