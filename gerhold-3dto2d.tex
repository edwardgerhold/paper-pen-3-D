...
Another philosophy to write $f_{n}(t)$ is to call the function after the variable like $x(t), y(t), z(t)$. I just want you to read this again.
...
Of course the number of arguments can vary.

\begin{displaymath}
f(\vec{x},t) = X(x,t)\begin{pmatrix}\cos\varphi_x\\\sin\varphi_x\end{pmatrix}
        +Y(y,t)\begin{pmatrix}\cos\varphi_y\\\sin\varphi_y\end{pmatrix}
        +Z(z,t)\begin{pmatrix}\cos\varphi_z\\\sin\varphi_z\end{pmatrix}
\end{displaymath}

Or 

\begin{displaymath}
f(x,y,z) = X(x)\begin{pmatrix}\cos\varphi_x\\\sin\varphi_x\end{pmatrix}
        +Y(y)\begin{pmatrix}\cos\varphi_y\\\sin\varphi_y\end{pmatrix}
        +Z(z)\begin{pmatrix}\cos\varphi_z\\\sin\varphi_z\end{pmatrix}
\end{displaymath}

They have all one thing in common. Instead of returning a 3-D vector, they return a 2-D vector, because we manipulated the basis.
...
\begin{displaymath}
\vec{q}_{n} := \{\vec{q}_{1}, \vec{q}_{2}, \vec{q}_{3}\}
\end{displaymath}

And can be renamed to \vec{e}_{n}.\\

Remark. I need images from the same functions before and after orthogonalization.\\
