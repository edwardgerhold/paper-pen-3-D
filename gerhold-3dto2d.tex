...
This is on top of the doc. I copied here, just for people who can imagine differential geometry.\\

This document will change in some days. My opinion is to write all again and remove all remarks. Of course i complete the begun calculations. I will add while writing the relevant new informations. I start a new paragraph above or below the old, finish it, and replace the old. There is still much more to advance in closely related to what i do here. The coordinate system sits on each of the planes of the cube around the three open intervals beetween zero and one, each origin is in the center. Each side of the cube brings a different view onto the inner coordinate system. A sphere with a tangent plane makes it possible to view the coordinate system inside from any angle. This is like arranging it on a circle on the plane, like we can look onto it, straight from any angle.\\
\\
My Proposition: The ker is not empty. It is a straight line through to the origin. All these points inside map onto $vec{0}$.\\
\\
I habe made a drawing with all these planes. You see, there is still more to advance.\\
\\
My Proposition: All covered points lie on a line normal to the plane we are looking from onto our box.\\
\\
We are not just taking the sines onto the surfaces to measure the distance and the height from above. We will not do it in this document anyways now. But you see, there is useful application for manifolds, too.\\
\\
Remark for advanced readers. With this coordinate systems derivatives giving just the same point for any x,y,z a lesson in differential geometry, vector fields, manifolds, differential equations can be solved, like why div u = f must have a non-linear f to obtain a solution u. I show the linear case. You can conclude, why a curve is needed to have a tangent and a continous derivative and not a constant like from a linear function, like we obtain here. There will be examples for this property in literature, for solving div f = u for example. I can not remember completly to explain quickly here.
...
Ich have agglomerated the Content of this Document on my own Behave. I have made up my mind to the topic
...
Mistakes may have been made by me, and Details may be not been recognized. For both i might excuse myself.
