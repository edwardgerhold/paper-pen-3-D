...
In our case the orthogonality by 90 degree rules of perpendicular basis vectors don not count. We arrange for example with about 120 degrees beetween each around the origin on a plane. The point is, the generic formula still holds.\\
