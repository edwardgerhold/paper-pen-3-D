...
I mean. In each of the three column vectors, the map to the plane is defined by orthogonality of the two columns. Even if we change
...
|a-b| \leq \sqrt{a^2+b^2}
|a-b| \leq c
\end{displaymath}

Remark. This wasn´t what i´ve written. It shouldn´t be, that i need my notes. But. Got to do it again.\\
