...
Version 0.2.1 (the very a draft paper)\\
...
It doesn´t matter, where you multiply with the constant. You can multiply the original vectors, or the resulting vectors. You reach the same point.\\
