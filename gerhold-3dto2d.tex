...
\begin{displaymath}
\text{rad}(\phi) := \frac{\pi}{180} \times \phi, \phi \elem \mathbb{R}
\end{displaymath}
...
Will be updated after importing a few official theorems, like for the orthogonal basis, 
plus the generic mxn case of the "http://de.wikipedia.org/wiki/Abbildungsmatrix" i found lately after beginning this document.
If you read the latter, you may find it not obvious, that you can transform the coordinates with that rule, too.
