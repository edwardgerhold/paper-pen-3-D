...
What about the vector of the integration constants, $\vec{C}$? We can solve easily. We know about the transformation, that the zero vector maps to the zero vector. So we can set the function to zero and solve for the constant vector.\\
...
is just a two liner of code projection, which i couldn´t even find in Wikipedia. Nothing special. And nothing to patent.\\

Remark. Informal version. Same opinion.\\

\begin{thebibliography}    
    \bibitem{Corral1} \textit{Michael Corral, Schoolcraft College},
    Vector Calculus, GNU Free Documentation License, http://mecmath.net (Gerhold: I am attending a german translation for 2015)
    \bibitem{Corral2} \textit{Michael Corral, Schoolcraft College},
        Trigonometry, GNU Free Documentation License, http://mecmath.net (Gerhold: I am attending a german translation for 2015)
