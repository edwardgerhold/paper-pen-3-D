...
Has to be ordered, corrected, mathematically upgraded and to get more pictures.
...
\begin{figure}[ht]
\includegraphics[scale=1]{helix.png}
\caption{A helix shown as (x,y,z)=f(t) with implement.html on a Canvas2DRenderingContext testing the javascript example code.}
\end{figure}
\begin{figure}[ht]
\includegraphics[scale=1]{fxyplot.png}
