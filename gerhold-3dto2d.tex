...
Version 0.1.8 (very drafty paper)\\
...
Gerhold Projection Matrix to distinguish it from other matrices, making sure it contains the three two dimensional and trigonometric basis vectors, which allow arranging the projection vectors just by going around the circle instead of.
...
\index{Theorem}
\newtheorem{Theorem}{Theorem (The Fundamental Theorem of converting 3-D Points into 2-D Points)}
\begin{Theorem} \emph{}:\\
