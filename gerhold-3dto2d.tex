...
\textbf{Definition} Let $\varphi_n$ be the set of axis angles, one for each axis. The angles start
...
\textbf{Definition} Let $e_n$ be the set of three two dimensional basis vectors, namely 
...
\emph{Proving rules of vector spaces.}\\
