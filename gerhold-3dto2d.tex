...
\textbf{Remark} This text may contain miscounts and maybe logical errors, \emph{typos},
...
onto two-component points, to a study, of the used vector spaces and the linear
combination, which is done. I will continue this study over the next days and weeks
with topology, linear operators, the dual space of the transpose, and also improve 
my linear algebra. I think it is worth studying the euclidean space and selfmade subspaces.
It is Hausdorff. :-)\\

I am also looking for a friendlier word for pseudo basis, like the basis-like \boldsymbol{A} is a
linear operator acting as a mediator beetween R3 and R2 coordinate systems. (A)(x) := Ax. By 
studying and doing formal calculations to this topic, i have seen, i´ve got to learn more. And i 
would like to apologize for my remark at the beginning, continue with some good text and a few 
new paragraphs, which may be incomplete, but happen over this cirrem week
...
\caption{The three two dimensional pseudo-basis vectors as a lefthanded coordinate system.}
\end{figure}
